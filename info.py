...
URL = "https://kr-url-shorten.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://kr-url-shorten.onrender.com".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://kr-url-shorten.onrender.com".format(FQDN)
else:
    URL = "https://kr-url-shorten.onrender.com".format(FQDN)
