...
API_ID = int(environ.get('API_ID', '17624470'))
API_HASH = environ.get('API_HASH', '77adcccdc70bc3bdedbc0d1b3b9bb6ee')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-2092094681').split()]
